...
?>     
        <form action="consultaPoblacion.php?pagina=0" method="POST">
            <h2 class="visually">Consulta Usuarios</h2>
            <div class="illustration">
                <div class="mb-3"><input class="form-control" type="text" name="POBLACION" placeholder="Poblacion a buscar" value="" ></div>
            </div>
