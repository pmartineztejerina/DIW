        ...
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
            <div class="container"><a class="navbar-brand" href="#">FORMULARIO REGISTRO DIW</a>
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="navbar-nav me-auto"></ul><span class="navbar-text actions"> <a class="login" href="#">Log In</a><a class="btn btn-light action-button" role="button" href="#">Sign Up</a></span>
                </div>
            </div>
        </nav>
        </section>
  ...
  if ($ENCUENTRAERROR == 1) {
    ...
    if ($results->num_rows > 0) {
      ...
      /* $verification_url = "https://www.pilarmartinez.me/DIW/verify.php?t=$verification_token&user=$user_id";
        ...
        echo "Error al dar de alta al usuario: " . "<br>" . mysqli_error($con);
      }
      mysqli_close($conn);
    }
  }
